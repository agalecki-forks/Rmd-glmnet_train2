...
cox_univariate <-
  tbl_uvregression(
    scrambled2[c("FU_TIME", "CASE_CONTROL", "eGFR_by_10_mL","B_HBA1C_PRC","log10_DU_ACR","Gender","AGE_TL","TNF.R1.npx","TNF.R2.npx","LTBR.npx","TNFRSF4.npx","TNFRSF6B.npx","CD27.npx","TNFRSF10A.npx","RELT.npx","EDA2R.npx","WFDC2.npx", "PI3_npx","CD160.npx","EPHA2.npx","EFNA4.npx","GFR_alpha_1_npx","DLL1.npx","LAYN.npx","SYND1.npx","KIM1.npx","PVRL4.npx","IL.1RT1.npx")],
    method = coxph,
...
# Predictor variables
predictors_var <- c("BL_eGFR","B_HBA1C_PRC","log10_DU_ACR","Gender","AGE_TL","TNF.R1.npx","TNF.R2.npx","LTBR.npx","TNFRSF4.npx","TNFRSF6B.npx","CD27.npx","TNFRSF10A.npx","RELT.npx","EDA2R.npx","WFDC2.npx", "PI3_npx","CD160.npx","EPHA2.npx","EFNA4.npx","GFR_alpha_1_npx","DLL1.npx","LAYN.npx","SYND1.npx","KIM1.npx","PVRL4.npx","IL.1RT1.npx")


# Calculate concordance for each predictor
results2 <- sapply(predictors_var, calculate_concordance, data = scrambled2)
...
# Univariate statistics by Quartile- Cox Model
...
# Predictor variables
predictors <- c("BL_eGFR_quartile","B_HBA1C_PRC_quartile","DU_ACR_quartile","Gender","AGE_TL_quartile","TNF.R1.npx_quartile","TNF.R2.npx_quartile","LTBR.npx_quartile","TNFRSF4.npx_quartile","TNFRSF6B.npx_quartile","CD27.npx_quartile","TNFRSF10A.npx_quartile","RELT.npx_quartile","EDA2R.npx_quartile","WFDC2.npx_quartile", "PI3_npx_quartile","CD160.npx_quartile","EPHA2.npx_quartile","EFNA4.npx_quartile","GFR_alpha_1_npx_quartile","DLL1.npx_quartile","LAYN.npx_quartile","SYND1.npx_quartile","KIM1.npx_quartile","PVRL4.npx_quartile","IL.1RT1.npx_quartile")
