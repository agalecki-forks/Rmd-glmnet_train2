...
# Univariate statistics by Categorical Quartile - Cox Model
...
cox_univariate_quartile <-
  tbl_uvregression(
    scrambled2[c("FU_TIME", "CASE_CONTROL", "BL_eGFR_quartile","B_HBA1C_PRC_quartile","DU_ACR_quartile","AGE_TL_quartile","TNF.R1.npx_quartile","TNF.R2.npx_quartile","LTBR.npx_quartile","TNFRSF4.npx_quartile","TNFRSF6B.npx_quartile","CD27.npx_quartile","TNFRSF10A.npx_quartile","RELT.npx_quartile","EDA2R.npx_quartile","WFDC2.npx_quartile", "PI3_npx_quartile","CD160.npx_quartile","EPHA2.npx_quartile","EFNA4.npx_quartile","GFR_alpha_1_npx_quartile","DLL1.npx_quartile","LAYN.npx_quartile","SYND1.npx_quartile","KIM1.npx_quartile","PVRL4.npx_quartile","IL.1RT1.npx_quartile")],
    method = coxph,
    y = Surv(FU_TIME, CASE_CONTROL),
    exponentiate = TRUE,
    pvalue_fun = function(x) style_pvalue(x, digits = 2)
...
# Univariate statistics by Numerical Quartile - Cox Model
...
cox_univariate_numeric_quartile <-
  tbl_uvregression(
    scrambled2[c("FU_TIME", "CASE_CONTROL", "BL_eGFR_quartile","B_HBA1C_PRC_quartile","DU_ACR_quartile","AGE_TL_quartile","TNF.R1.npx_quartile","TNF.R2.npx_quartile","LTBR.npx_quartile","TNFRSF4.npx_quartile","TNFRSF6B.npx_quartile","CD27.npx_quartile","TNFRSF10A.npx_quartile","RELT.npx_quartile","EDA2R.npx_quartile","WFDC2.npx_quartile", "PI3_npx_quartile","CD160.npx_quartile","EPHA2.npx_quartile","EFNA4.npx_quartile","GFR_alpha_1_npx_quartile","DLL1.npx_quartile","LAYN.npx_quartile","SYND1.npx_quartile","KIM1.npx_quartile","PVRL4.npx_quartile","IL.1RT1.npx_quartile")],
    method = coxph,
    y = Surv(FU_TIME, CASE_CONTROL),
