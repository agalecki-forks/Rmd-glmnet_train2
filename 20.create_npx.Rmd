...
Script bnm executed by `r username`.

# Original NPX Data: `r "npx_data_orig"`
...
* Checking for missing values in time vars. Data `tvars_sel` should be empty 
...
miss_res2 =check_survival_consistency2( npxdata_all, 
                          index_var = "INDEX", 
                          time_var = "time", 
                          status_var = "status", 
