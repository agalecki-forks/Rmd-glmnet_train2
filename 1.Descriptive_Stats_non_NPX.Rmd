...
scrambled2 <- scrambled  %>% 
          ...
          select("Gender","Status","Death" , "FU_TIME" ,"FU_TIME_Death","SBP_TL","DBP_TL" , 
                 ...
                 "EDA2R" ,"TNFRSF4" ,"GFR_alpha_1", "TNF.R1", "PI3" , 
...
var_num <- scrambled  %>% select("FU_TIME" ,"FU_TIME_Death","SBP_TL","DBP_TL" , "AGEONSET_TL" , "BMI_TL","AGE_TL" , "B_HBA1C_PRC","log10_B_HBA1C_PRC", "DU_ACR","log10_DU_ACR","BL_eGFR","KIM1" ,"SYND1","IL.1RT1","WFDC2",      "CD27" , "TNFRSF10A","LAYN","PVRL4", "EDA2R" ,"TNFRSF4" ,"GFR_alpha_1", "TNF.R1", "PI3" , "EFNA4","TNF.R2" ,"DLL1" ,"TNFRSF6B" , "CD160","EPHA2","RELT","LTBR") 
...
Case <- scrambled %>% filter (CASE_CONTROL==1) %>% select("FU_TIME" ,"FU_TIME_Death","SBP_TL","DBP_TL" , "AGEONSET_TL" , "BMI_TL","AGE_TL" , "B_HBA1C_PRC","log10_B_HBA1C_PRC", "DU_ACR","log10_DU_ACR","BL_eGFR","KIM1" ,"SYND1","IL.1RT1","WFDC2",      "CD27" , "TNFRSF10A","LAYN","PVRL4", "EDA2R" ,"TNFRSF4" ,"GFR_alpha_1", "TNF.R1", "PI3" , "EFNA4","TNF.R2" ,"DLL1" ,"TNFRSF6B" , "CD160","EPHA2","RELT","LTBR") 
...
Control <- scrambled %>% filter (CASE_CONTROL==0) %>% select("FU_TIME" ,"FU_TIME_Death","SBP_TL","DBP_TL" , "AGEONSET_TL" , "BMI_TL","AGE_TL" , "B_HBA1C_PRC","log10_B_HBA1C_PRC", "DU_ACR","log10_DU_ACR","BL_eGFR","KIM1" ,"SYND1","IL.1RT1","WFDC2",      "CD27" , "TNFRSF10A","LAYN","PVRL4", "EDA2R" ,"TNFRSF4" ,"GFR_alpha_1", "TNF.R1", "PI3" , "EFNA4","TNF.R2" ,"DLL1" ,"TNFRSF6B" , "CD160","EPHA2","RELT","LTBR") 
...
proteins <- c("KIM1",      "SYND1", "IL.1RT1","WFDC2", "CD27",
              ...
              "GFR_alpha_1", "TNF.R1", "PI3" , "EFNA4","TNF.R2" ,
