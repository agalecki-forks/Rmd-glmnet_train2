...
names(glmnet_list) <- paste0("a",alphv)
```
...
names(cvglmnet_list) <- paste0("a", alphv)
```
...
save(vars,  sel3long, cva_modlist, glmnet_list, cvglmnet_list, file = fpath1) # train_data not saved

fpath1_train <- paste0("./save/5.Cox_tidy_train", mod_lbl, ".Rdata")
save(train_data, file = fpath1_train) # train_data saved
