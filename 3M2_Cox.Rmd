---
title: 'Regularized for Cox Regression Model'
...
# Introduction (`r params$mod_lbl`)

In this report we consider Cox regression model `r params$mod_lbl` for the time-to-event `time` variable. Originally this 
...
```{r  pred-coxnet}
#' Predicted values for _coxnet model fit
#'
...
* `vars` vector contains variable names specific to the models considered in this docu,ent
