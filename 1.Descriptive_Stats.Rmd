...
```{r Correlation-proteins-ord, echo=FALSE, message=FALSE, warning=FALSE,fig.width = 90, fig.height=60, dev ="svg"}

ord <- hcl$order
cors_ord <- cors[ord,ord]
cors_ord <- round(cors_ord,2)
corrplot.mixed(cors_ord, upper ="pie", lower="number", tl.pos ="lt",
 mar = c(0,0,2,0), tl.cex=7, main="Correlation matrix", number.cex =5,
 lower.col="black")
