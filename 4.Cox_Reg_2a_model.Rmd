...
```{r save-cva_pfit1}
save(cva_pfit1, file = "./save/21Cox-Reg2a-save1.Rdata")
```
...
cvfit2 <- cv.glmnet(x2, y2Surv, family = "cox", type.measure = "C", alpha=0)
...
set.seed(46)
alphv <- seq(0, 1, len = 11)^3
cva_pfit2 <- cva.glmnet(x=x2,y=y2Surv,family = "cox", type.measure = "C", alpha = alphv)
...
```{r save-cva_pfit2_M2}
save(cva_pfit2, file = "./save/21Cox-Reg2a-save2.Rdata")
```
