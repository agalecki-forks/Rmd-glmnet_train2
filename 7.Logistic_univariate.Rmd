...
# Define the function to calculate the c-statistic
calculate_cstat <- function(predictor, data) {
  ...
  predicted_probs <- predict(fit, data, type = "response")
  
  # Calculate the c-statistic
  cstat <- roc(data$CASE_CONTROL, predicted_probs)$auc
...
# Calculate c-statistic for each predictor
results <- sapply(predictors, calculate_cstat, data = scrambled2)

# Create a data frame with the c-statistic results
results_df <- data.frame(C_statistic = results)

# Print the results data frame
print(results_df)
```

# Univariate statistics by Quartile- Logistic Model
...
Logistic_univariate <-
  tbl_uvregression(
    scrambled2[c("CASE_CONTROL", "BL_eGFR_quartile","B_HBA1C_PRC_quartile","DU_ACR_quartile","Gender","AGE_TL_quartile","TNF.R1.npx_quartile","TNF.R2.npx_quartile","LTBR.npx_quartile","TNFRSF4.npx_quartile","TNFRSF6B.npx_quartile","CD27.npx_quartile","TNFRSF10A.npx_quartile","RELT.npx_quartile","EDA2R.npx_quartile","WFDC2.npx_quartile", "PI3_npx_quartile","CD160.npx_quartile","EPHA2.npx_quartile","EFNA4.npx_quartile","GFR_alpha_1_npx_quartile","DLL1.npx_quartile","LAYN.npx_quartile","SYND1.npx_quartile","KIM1.npx_quartile","PVRL4.npx_quartile","IL.1RT1.npx_quartile")],
    method = glm,
    y = CASE_CONTROL,
    method.args = list(family = binomial),
    exponentiate = TRUE
...
# Predictor variables
predictors <- c("BL_eGFR_quartile", "B_HBA1C_PRC_quartile", "DU_ACR_quartile", "Gender", "AGE_TL_quartile",
                "TNF.R1.npx_quartile", "TNF.R2.npx_quartile", "LTBR.npx_quartile", "TNFRSF4.npx_quartile",
                "TNFRSF6B.npx_quartile", "CD27.npx_quartile", "TNFRSF10A.npx_quartile", "RELT.npx_quartile",
                "EDA2R.npx_quartile", "WFDC2.npx_quartile", "PI3_npx_quartile", "CD160.npx_quartile",
                "EPHA2.npx_quartile", "EFNA4.npx_quartile", "GFR_alpha_1_npx_quartile", "DLL1.npx_quartile",
                "LAYN.npx_quartile", "SYND1.npx_quartile", "KIM1.npx_quartile", "PVRL4.npx_quartile",
